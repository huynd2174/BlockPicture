...
import { PuzzleDragController } from './PuzzleDragController';
...
@ccclass('GameHUDController')
export class GameHUDController extends Component {
    @property(LevelBlockSpawner)
    levelSpawner: LevelBlockSpawner | null = null;

    @property(PuzzleDragController)
    dragController: PuzzleDragController | null = null;
